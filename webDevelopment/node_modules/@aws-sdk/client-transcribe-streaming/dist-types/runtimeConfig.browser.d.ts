...
export declare const getRuntimeConfig: (config: TranscribeStreamingClientConfig) => {
    ...
    requestHandler: (import("@aws-sdk/types").RequestHandler<any, any, import("@aws-sdk/types").HttpHandlerOptions> & import("@smithy/protocol-http").HttpHandler) | WebSocketRequestHandler;
